...
>
> **补充：2026-08-25 Mac 100M 子集（无状态查询 q1/q2/q3/q10/q14/q21/q22）**——首次
> 与白皮书**同 100M 规模**对照：vs OSS 4.13×~18.47×、vs VVR 1.20×~4.98×（7/7 达 VVR；
> 10 核常载 Mac，load 4.4~7.9，读数偏保守），见 `BENCH_RESULTS.md`。
