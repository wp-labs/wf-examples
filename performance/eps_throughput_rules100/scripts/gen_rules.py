...
def conn_extra_rules():
    ...
    for name, key, guard, n in [
        ...
        ("g_geo_city_30", "sip", 'c.conn_info.geo.city == "Shanghai"', 30),
        ("g_geo_city_60", "dip", 'c.conn_info.geo.city == "Shanghai"', 60),
        ("g_geo_flow_60", "sip", 'indexof(c.conn_info.flow_id, "flow-") == 0', 60),
